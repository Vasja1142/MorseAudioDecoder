...
*Эти графики помогают оценить стабильность обучения, наличие переобучения и общую производительность модели на разных этапах. На графике `Train Loss` видим улучшение точности на всем протяжении обучения, однако на графике `Levenshtein Distance` после 11 эпохи нет прироста производительности что говорит нам о начале переобучения. Следующим этапом становится дообучение модели с 11 эпохи с результатом `Levenshtein Distance` = **`0.3133`***
